...
class PolynomialRegression:
    ...
    Representation invariants:
      ...
      - len(coefficients) <= len(x_values)
      - len(error_values) = len(x_values)
    ...
    def __init__(self, data: List[Tuple[float, float]], degree: int) -> None:
        """ Initializes the polynomial regression model of specified degree
    ...
    def extreme_absolute_error(self) -> Dict[str, float]:
        """Returns a dictionary of minimum absolute error: value
