...
There are many factors to consider, such as the carbon dioxide to oxygen conversion, tendency to trap heat due to their dark colour, 
...
With these major evidences of deforestation correlating to the change in global and local climate, we believe that it is a relevant topic to contemporary society that should not be ignored.
\end{text}
